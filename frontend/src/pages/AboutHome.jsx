  ...
  return (
    <div className="position-relative">
      ...
      <div style={styles.container}>
        ...
        <br /><br />
        <h4>At <strong>res-pe</strong>, we believe that cooking should be fun, easy, and accessible to everyone. Whether you're a beginner or a seasoned chef, our platform is designed to help you explore, create, and share delicious recipes from around the world.</h4>
        <br /><br /><br />
        <h1>Our Mission</h1>
        <ul>
          <li className="bg-success-subtle rounded p-3 m-2">
            <h4>✔ Discover new recipes from different cuisines.</h4>
          </li>

          <li className="bg-success-subtle rounded p-3 m-2">
            <h4>✔ Share their own unique recipes with the community.</h4>
          </li>
